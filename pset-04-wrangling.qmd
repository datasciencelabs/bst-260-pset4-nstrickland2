...
regions <- url |>
  ...
  filter(!(state_name %in% c("Virgin Islands", "American Samoa", "Commonwealth of the Northern Mariana Islands", "Federated States of Micronesia", "Guam", "Marshall Islands", "Republic of Palau"))) |> # remove places that aren't the 50 states, PR, or DC
